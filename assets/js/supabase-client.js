...
class SupabaseClient {
    ...
    async getLeaderboardStats() {
        try {
            ...
            const streakValues = Array.isArray(data)
                ? data.map(user => user.best_streak || 0)
                : [];
    ...
    showUserProfile(container) {
        ...
        container.innerHTML = `
            <div class="user-profile">
                ...
                <button class="logout-btn" onclick="window.supabaseClient.signOut()" title="${this.t('logout')}">
