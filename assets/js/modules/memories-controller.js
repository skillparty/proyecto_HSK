  ...
  constructor(app) {
    ...
    this.memoriesData = [
      ...
      },
      {
        ...
        descEn: "The prestigious Chinese language and culture competition, where Nicole shined winning 1st Place in Bolivia (Champion) bringing immense honor and pride to ICUMSS.",
        tags: ["Puente Chino", "1er Lugar Bolivia", "Nicole", "Campeona", "Elocuencia", "ICUMSS"],
        vocab: [
      ...
      // 5. SPECIAL MOMENTS & FRIENDSHIP
      {
        ...
        descEn: "Celebrating Nicole's historic 1st Place victory in Bolivia at the Chinese Bridge Competition (汉语桥)! A testament to talent and perseverance celebrated with great pride, alongside memories of friendship.",
        tags: ["Nicole", "1er Lugar Bolivia", "Puente Chino", "Campeona", "Amistad", "Orgullo", "ICUMSS"],
        vocab: [
          { hanzi: "冠军", pinyin: "guànjūn", meaning: "campeón / 1er lugar" },
          { hanzi: "汉语桥", pinyin: "Hànyǔ Qiáo", meaning: "Puente Chino" },
