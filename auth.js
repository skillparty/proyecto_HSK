    ...
    showGuestMode() {
        ...
        authContainer.innerHTML = `
            <div class="auth-guest-mode">
                ...
                <button id="enable-auth-btn" class="auth-enable-btn" title="Enable GitHub authentication">
        ...
        // Add event listener for auth setup
        document.getElementById('enable-auth-btn').addEventListener('click', () => this.checkSetup());
