...
const pending = english.filter((item) => item.level === 1 && !hasSpanishEntry(item));
...
(async () => {
  ...
  console.log(`HSK1 remaining auto-complete done. Inserted=${inserted}, FallbackToEnglish=${fallbackToEnglish}, Total=${spanish.length}`);
})();
