const SW_VERSION = "4.9.0-culture-modules-fix";
...
const PRECACHE_FILES = [
  ...
  "./assets/js/modules/ui-controller.js?v=4",
  "./assets/js/modules/navigation-controller.js?v=4",
  "./assets/js/modules/culture/culture-module-base.js?v=1",
  "./assets/js/modules/culture/character-evolution.js?v=1",
  "./assets/js/modules/culture/traditional-medicine.js?v=1",
  "./assets/js/modules/culture/peking-opera.js?v=1",
  "./assets/js/modules/culture/chinese-technology.js?v=1",
