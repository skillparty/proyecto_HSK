const SW_VERSION = "4.2.0-snake-redesign";
...
const PRECACHE_FILES = [
  ...
  "./assets/css/quantifier-snake-styles.css?v=2",
  ...
  "./assets/js/modules/quantifier-snake-canvas.js?v=2",
  "./assets/js/modules/quantifier-snake-controller.js?v=2",
